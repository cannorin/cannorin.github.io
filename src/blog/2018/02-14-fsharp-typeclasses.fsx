(*@
    Layout = "post";
    Title = "F# で型クラス";
    Date = "2018-02-14T03:54:24";
    Tags = "F#,type system";
    Description = "inline functions と statically resolved type parameters を悪用します" ;
*)

(**

F# は OCaml を .NET に乗っけて色々足した言語だが、その過程で失ってしまったものもたくさんあり、
その中でも特に痛いのは functor がないことだ。
...
(**
とりあえず Haskell の do-notation を実現する。

まず、名前を言ってはいけないあの概念を表す "型クラス" を作る。
*)
...
`do` は残念ながら予約後なので恐怖の M-word で代用する。
*)
